...
----
oc create -f $HOME/support/openshift_logging_namespace.yaml
----
...
kibana   kibana-openshift-logging.%cluster_subdomain%          kibana     <all>   reencrypt/Redirect   None
----

Or, you can control+click the link:

https://kibana-openshift-logging.%cluster_subdomain%
