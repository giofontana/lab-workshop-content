...
[source,bash,role="execute"]
----
cat $HOME/support/project_request_template.yaml
----
...
[source,bash,role="execute"]
----
oc apply -f $HOME/support/project_request_template.yaml -n openshift-config
----
...
[source,bash,role="execute"]
----
oc apply -f $HOME/support/cr_project_request.yaml -n openshift-config
----
